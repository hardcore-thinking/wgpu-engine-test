...
namespace Math {
    ...
    float const& Matrix3x3::operator [] (size_t index) const {
        assert("Index must be in the bounds of the matrix"
            && index >= 0 && index < 9);
    ...
    float& Matrix3x3::operator () (size_t n, size_t m) {
    ...
    float const& Matrix3x3::operator () (size_t n, size_t m) const {
        assert("Indices must be in the bounds of the matrix"
            && n >= 0 && n < 3
            && m >= 0 && m < 3);
    ...
    Vector3 Matrix3x3::Line(size_t n) const {
        assert("Indices must be in the bounds of the matrix"
               && n >= 0 && n < 3);
        return Vector3(
            (*this)(n, 0),
    ...
    Vector3 Matrix3x3::Column(size_t m) const {
        assert("Indices must be in the bounds of the matrix"
               && m >= 0 && m < 3);
        return Vector3(
            (*this)(0, m),
